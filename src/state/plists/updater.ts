import { VersionUpgrade, getVersionUpgrade, minVersionBump } from '@kalycoinproject/token-lists';
      ...
      if (list.current && list.pendingUpdate) {
        ...
        switch (bump) {
          ...
          case VersionUpgrade.MINOR:
            ...
            if (bump >= min) {
              if (isDefaultList) {
                //if its kalyswap hosted token list then we will autoupdate it
