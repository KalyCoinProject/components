...
import { JSBI, Percent, Router, SwapParameters, Trade, TradeType } from '@kalycoinproject/sdk';
...
import { useKalyswapWeb3 } from './index';
...
function useSwapCallArguments(
  ...
  const { account, chainId, library } = useKalyswapWeb3();
                ...
                return contract.callStatic[methodName](...args, options)
                  ...
                  .catch((callError) => {
                    ...
                    switch (callError.reason) {
                      case 'KalyswapRouter: INSUFFICIENT_OUTPUT_AMOUNT':
                      case 'KalyswapRouter: EXCESSIVE_INPUT_AMOUNT':
                        errorMessage =
