...
export const DEFAULT_TOKEN_LISTS: string[] = [KALYSWAP_LIST];

// Token addresses (excluding KSWAP and WKLC) ported from:
// https://raw.githubusercontent.com/kalycoinproject/tokenlists/main/aeb.tokenlist.json
export const AEB_TOKENS: string[] = [
